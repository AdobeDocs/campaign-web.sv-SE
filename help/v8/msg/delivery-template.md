...
Alla mallar som [skapades](#create-a-delivery-template) i den aktuella miljön visas.
...
1. Bläddra till fliken **Mallar** på den vänstra menyn **Leveranser** . [Läs mer](#access-manage-templates)
...
1. Definiera mallegenskaperna, [målgrupp](../audience/add-audience.md) och innehållet beroende på den valda kanalen.
...
1. Klicka på knappen **[!UICONTROL Simulate content]** överst till höger på skärmen.
